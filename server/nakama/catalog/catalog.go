...
var seedEntries = []Game{
	{ID: "hockey", Name: "Ice Clash", Tagline: "One rink. Two rivals. First to five.", Description: "Glide, steal, and score in a fast arcade hockey duel with automatic goalkeepers.", MinPlayers: 2, MaxPlayers: 2},
