export const GAMES = [
  ...
  { id: 'battleship', name: 'Fleet Command', genre: 'Strategy', label: 'STRATEGY · NAVAL DUEL', description: 'Hide your fleet, read your rival, and send their last ship to the ocean floor.', duration: '10–15 min', color: 'teal', practice: true },
] as const;
