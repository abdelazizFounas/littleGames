...
export function AppLayout() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const labels: Record<string, string> = {'/': 'Small games, big rivalries', '/guide': 'How to play', '/login': 'Sign in', '/privacy': 'Your data', '/profile': 'My profile', '/games/artillery': 'Pocket Artillery', '/practice/artillery': 'Pocket Artillery practice', '/games/arena': 'Rift Arena', '/games/pong': 'Neon Pong', '/games/battleship': 'Fleet Command', '/practice/arena': 'Rift Arena practice', '/practice/pong': 'Neon Pong practice', '/practice/battleship': 'Fleet Command practice'};
